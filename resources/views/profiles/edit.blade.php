<x-app>
    <form method="POST" action="{{ $user->path() }}" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-400 p-2 w-full rounded-2xl" name="name" id="name" required value="{{ $user->name }}">
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-400 p-2 w-full rounded-2xl" name="username" id="username" value="{{ $user->username }}" required>
        ...
        <div class="mb-6">
            ...
            <input type="email" class="border border-gray-400 p-2 w-full rounded-2xl" name="email" id="email" value="{{ $user->email }}" required>
        ...
        <div class="mb-6">
            ...
            <input type="password" class="border border-gray-400 p-2 w-full rounded-2xl" name="password" id="password" required>
        ...
        <div class="mb-6">
            ...
            <input type="password" class="border border-gray-400 p-2 w-full rounded-2xl" name="password_confirmation" id="password_confirmation" required>
        ...
        <div class="mb-6">
            <button class="bg-blue-400 text-white rounded py-2 px-4 hover:bg-blue-500 mr-6">Submit</button>
