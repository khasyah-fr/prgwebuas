<div class="flex p-4 border-b border-b-gray-400">
    ...
    <div>
        <h5 class="font-bold mb-4"><a href="{{ $tweet->user->path() }}">{{ $tweet->user->username }}</a></h5>
        ...
        <div class="flex">
            <form action="/tweets/{{ $tweet->id }}/like" method="POST">
                ...
                <div class="flex items-center mr-3 {{ $tweet->isLikedby(current_user()) ? 'text-blue-400' : 'text-gray-400' }}">
                    <svg viewBox="0 0 20 20" class="w-3 mr-2" style="transform: scale(-1,1);">
            ...
            <form action="/tweets/{{ $tweet->id }}/like" method="POST">
                ...
                <div class="flex items-center {{ $tweet->isDislikedby(current_user()) ? 'text-blue-400' : 'text-gray-400' }}">
                    <svg viewBox="0 0 20 20" class="w-3 mr-2">
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g class="fill-current">
